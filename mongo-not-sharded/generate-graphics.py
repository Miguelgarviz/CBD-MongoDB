...
df = pd.read_csv('mongo-not-sharded/results/not_sharded_results.csv', names=col_names, header=None)
...
# 6. Guardar y mostrar
plt.tight_layout()
plt.savefig('mongo-not-sharded/graphics/grafica_nodo_unico.png', dpi=300)
plt.show()